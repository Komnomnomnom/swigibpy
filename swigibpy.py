...
def Contract_CloneComboLegs(dst, src):
...
_swigibpy.CUSTOMER_swigconstant(_swigibpy)
CUSTOMER = _swigibpy.CUSTOMER

_swigibpy.FIRM_swigconstant(_swigibpy)
FIRM = _swigibpy.FIRM

_swigibpy.UNKNOWN_swigconstant(_swigibpy)
UNKNOWN = _swigibpy.UNKNOWN

_swigibpy.AUCTION_UNSET_swigconstant(_swigibpy)
AUCTION_UNSET = _swigibpy.AUCTION_UNSET

_swigibpy.AUCTION_MATCH_swigconstant(_swigibpy)
AUCTION_MATCH = _swigibpy.AUCTION_MATCH

_swigibpy.AUCTION_IMPROVEMENT_swigconstant(_swigibpy)
AUCTION_IMPROVEMENT = _swigibpy.AUCTION_IMPROVEMENT

_swigibpy.AUCTION_TRANSPARENT_swigconstant(_swigibpy)
...
def Order_CloneOrderComboLegs(dst, src):
...
_swigibpy.NO_ROW_NUMBER_SPECIFIED_swigconstant(_swigibpy)
...
_swigibpy.BID_SIZE_swigconstant(_swigibpy)
BID_SIZE = _swigibpy.BID_SIZE

_swigibpy.BID_swigconstant(_swigibpy)
BID = _swigibpy.BID

_swigibpy.ASK_swigconstant(_swigibpy)
ASK = _swigibpy.ASK

_swigibpy.ASK_SIZE_swigconstant(_swigibpy)
ASK_SIZE = _swigibpy.ASK_SIZE

_swigibpy.LAST_swigconstant(_swigibpy)
LAST = _swigibpy.LAST

_swigibpy.LAST_SIZE_swigconstant(_swigibpy)
LAST_SIZE = _swigibpy.LAST_SIZE

_swigibpy.HIGH_swigconstant(_swigibpy)
HIGH = _swigibpy.HIGH

_swigibpy.LOW_swigconstant(_swigibpy)
LOW = _swigibpy.LOW

_swigibpy.VOLUME_swigconstant(_swigibpy)
VOLUME = _swigibpy.VOLUME

_swigibpy.CLOSE_swigconstant(_swigibpy)
CLOSE = _swigibpy.CLOSE

_swigibpy.BID_OPTION_COMPUTATION_swigconstant(_swigibpy)
BID_OPTION_COMPUTATION = _swigibpy.BID_OPTION_COMPUTATION

_swigibpy.ASK_OPTION_COMPUTATION_swigconstant(_swigibpy)
ASK_OPTION_COMPUTATION = _swigibpy.ASK_OPTION_COMPUTATION

_swigibpy.LAST_OPTION_COMPUTATION_swigconstant(_swigibpy)
LAST_OPTION_COMPUTATION = _swigibpy.LAST_OPTION_COMPUTATION

_swigibpy.MODEL_OPTION_swigconstant(_swigibpy)
MODEL_OPTION = _swigibpy.MODEL_OPTION

_swigibpy.OPEN_swigconstant(_swigibpy)
OPEN = _swigibpy.OPEN

_swigibpy.LOW_13_WEEK_swigconstant(_swigibpy)
LOW_13_WEEK = _swigibpy.LOW_13_WEEK

_swigibpy.HIGH_13_WEEK_swigconstant(_swigibpy)
HIGH_13_WEEK = _swigibpy.HIGH_13_WEEK

_swigibpy.LOW_26_WEEK_swigconstant(_swigibpy)
LOW_26_WEEK = _swigibpy.LOW_26_WEEK

_swigibpy.HIGH_26_WEEK_swigconstant(_swigibpy)
HIGH_26_WEEK = _swigibpy.HIGH_26_WEEK

_swigibpy.LOW_52_WEEK_swigconstant(_swigibpy)
LOW_52_WEEK = _swigibpy.LOW_52_WEEK

_swigibpy.HIGH_52_WEEK_swigconstant(_swigibpy)
HIGH_52_WEEK = _swigibpy.HIGH_52_WEEK

_swigibpy.AVG_VOLUME_swigconstant(_swigibpy)
AVG_VOLUME = _swigibpy.AVG_VOLUME

_swigibpy.OPEN_INTEREST_swigconstant(_swigibpy)
OPEN_INTEREST = _swigibpy.OPEN_INTEREST

_swigibpy.OPTION_HISTORICAL_VOL_swigconstant(_swigibpy)
OPTION_HISTORICAL_VOL = _swigibpy.OPTION_HISTORICAL_VOL

_swigibpy.OPTION_IMPLIED_VOL_swigconstant(_swigibpy)
OPTION_IMPLIED_VOL = _swigibpy.OPTION_IMPLIED_VOL

_swigibpy.OPTION_BID_EXCH_swigconstant(_swigibpy)
OPTION_BID_EXCH = _swigibpy.OPTION_BID_EXCH

_swigibpy.OPTION_ASK_EXCH_swigconstant(_swigibpy)
OPTION_ASK_EXCH = _swigibpy.OPTION_ASK_EXCH

_swigibpy.OPTION_CALL_OPEN_INTEREST_swigconstant(_swigibpy)
OPTION_CALL_OPEN_INTEREST = _swigibpy.OPTION_CALL_OPEN_INTEREST

_swigibpy.OPTION_PUT_OPEN_INTEREST_swigconstant(_swigibpy)
OPTION_PUT_OPEN_INTEREST = _swigibpy.OPTION_PUT_OPEN_INTEREST

_swigibpy.OPTION_CALL_VOLUME_swigconstant(_swigibpy)
OPTION_CALL_VOLUME = _swigibpy.OPTION_CALL_VOLUME

_swigibpy.OPTION_PUT_VOLUME_swigconstant(_swigibpy)
OPTION_PUT_VOLUME = _swigibpy.OPTION_PUT_VOLUME

_swigibpy.INDEX_FUTURE_PREMIUM_swigconstant(_swigibpy)
INDEX_FUTURE_PREMIUM = _swigibpy.INDEX_FUTURE_PREMIUM

_swigibpy.BID_EXCH_swigconstant(_swigibpy)
BID_EXCH = _swigibpy.BID_EXCH

_swigibpy.ASK_EXCH_swigconstant(_swigibpy)
ASK_EXCH = _swigibpy.ASK_EXCH

_swigibpy.AUCTION_VOLUME_swigconstant(_swigibpy)
AUCTION_VOLUME = _swigibpy.AUCTION_VOLUME

_swigibpy.AUCTION_PRICE_swigconstant(_swigibpy)
AUCTION_PRICE = _swigibpy.AUCTION_PRICE

_swigibpy.AUCTION_IMBALANCE_swigconstant(_swigibpy)
AUCTION_IMBALANCE = _swigibpy.AUCTION_IMBALANCE

_swigibpy.MARK_PRICE_swigconstant(_swigibpy)
MARK_PRICE = _swigibpy.MARK_PRICE

_swigibpy.BID_EFP_COMPUTATION_swigconstant(_swigibpy)
BID_EFP_COMPUTATION = _swigibpy.BID_EFP_COMPUTATION

_swigibpy.ASK_EFP_COMPUTATION_swigconstant(_swigibpy)
ASK_EFP_COMPUTATION = _swigibpy.ASK_EFP_COMPUTATION

_swigibpy.LAST_EFP_COMPUTATION_swigconstant(_swigibpy)
LAST_EFP_COMPUTATION = _swigibpy.LAST_EFP_COMPUTATION

_swigibpy.OPEN_EFP_COMPUTATION_swigconstant(_swigibpy)
OPEN_EFP_COMPUTATION = _swigibpy.OPEN_EFP_COMPUTATION

_swigibpy.HIGH_EFP_COMPUTATION_swigconstant(_swigibpy)
HIGH_EFP_COMPUTATION = _swigibpy.HIGH_EFP_COMPUTATION

_swigibpy.LOW_EFP_COMPUTATION_swigconstant(_swigibpy)
LOW_EFP_COMPUTATION = _swigibpy.LOW_EFP_COMPUTATION

_swigibpy.CLOSE_EFP_COMPUTATION_swigconstant(_swigibpy)
CLOSE_EFP_COMPUTATION = _swigibpy.CLOSE_EFP_COMPUTATION

_swigibpy.LAST_TIMESTAMP_swigconstant(_swigibpy)
LAST_TIMESTAMP = _swigibpy.LAST_TIMESTAMP

_swigibpy.SHORTABLE_swigconstant(_swigibpy)
SHORTABLE = _swigibpy.SHORTABLE

_swigibpy.FUNDAMENTAL_RATIOS_swigconstant(_swigibpy)
FUNDAMENTAL_RATIOS = _swigibpy.FUNDAMENTAL_RATIOS

_swigibpy.RT_VOLUME_swigconstant(_swigibpy)
RT_VOLUME = _swigibpy.RT_VOLUME

_swigibpy.HALTED_swigconstant(_swigibpy)
HALTED = _swigibpy.HALTED

_swigibpy.BID_YIELD_swigconstant(_swigibpy)
BID_YIELD = _swigibpy.BID_YIELD

_swigibpy.ASK_YIELD_swigconstant(_swigibpy)
ASK_YIELD = _swigibpy.ASK_YIELD

_swigibpy.LAST_YIELD_swigconstant(_swigibpy)
LAST_YIELD = _swigibpy.LAST_YIELD

_swigibpy.CUST_OPTION_COMPUTATION_swigconstant(_swigibpy)
CUST_OPTION_COMPUTATION = _swigibpy.CUST_OPTION_COMPUTATION

_swigibpy.TRADE_COUNT_swigconstant(_swigibpy)
TRADE_COUNT = _swigibpy.TRADE_COUNT

_swigibpy.TRADE_RATE_swigconstant(_swigibpy)
TRADE_RATE = _swigibpy.TRADE_RATE

_swigibpy.VOLUME_RATE_swigconstant(_swigibpy)
VOLUME_RATE = _swigibpy.VOLUME_RATE

_swigibpy.LAST_RTH_TRADE_swigconstant(_swigibpy)
LAST_RTH_TRADE = _swigibpy.LAST_RTH_TRADE

_swigibpy.NOT_SET_swigconstant(_swigibpy)
NOT_SET = _swigibpy.NOT_SET

def isPrice(tickType):
    """isPrice(TickType tickType) -> bool"""
    return _swigibpy.isPrice(tickType)
